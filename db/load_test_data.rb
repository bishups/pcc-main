...
4.times do |index|
  kit=Kit.new(:condition=>"Good",:name=>"#{Sector.find(2).centers.limit(2).first.name} - Kit",:capacity=>50,:centers=>Sector.find(2).centers.limit(2))
  kit.save
  seed_data["KitItemType"].collect do |kit_item_type|
    kit_item_type=KitItemType.where(:name=>kit_item_type).first
    kit_item = KitItem.new(:kit=>kit,:description=>" Newly Purchased #{kit_item_type}", :condition=>"Good",:count=>3,:kit_item_type=>kit_item_type)
...
4.times do |index|
  kit=Kit.new(:condition=>"Good",:name=>"#{Sector.first.centers.limit(1).first.name} - Kit",:capacity=>50,:centers=>Sector.first.centers.limit(1))
  kit.save
  seed_data["KitItemType"].collect do |kit_item_type|
    kit_item_type=KitItemType.where(:name=>kit_item_type).first
    kit_item = KitItem.new(:kit=>kit,:description=>" Newly Purchased #{kit_item_type}", :condition=>"Good",:count=>3,:kit_item_type=>kit_item_type)
