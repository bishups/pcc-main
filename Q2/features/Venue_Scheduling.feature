Feature: Venue Management, Given the user logged in as Venue Coordinator, user should be able to manage Venues. 


Background: 
Given user have launched the pcc application URL and logged in as Kit Coordinator
