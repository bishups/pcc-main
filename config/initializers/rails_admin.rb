RailsAdmin.config do |config|
  ...
  config.included_models = [AccessPrivilege, Timing, Kit, KitItem, KitItemType, Teacher, User, Zone, Sector, Venue, Center, ProgramType, Permission, Role, Pincode, Comment, Notification]
